...
function initVegasSlider() {
    jQuery("#bgvid").vegas({
        slides: [
            {   src: '/themes/oreo/assets/images/img22.jpg',
                video: {
                    src: [
                        '/themes/oreo/assets/video/polina.webm',
                        '/themes/oreo/assets/video/polina.mp4'
                    ],
                    loop: true,
                    timer: false,
                    mute: true
...
function initGoogleMap() {
    jQuery('.map').googleMapAPI({
        marker: '/themes/oreo/assets/images/marker.png',
